...
**Note:** TrackChangesPrimitive is one of three primitives (with CommentPrimitive and BookmarkPrimitive) that independently implement an **anchor pattern**. See [family-level convergence question](../docs/plans/2026-04-19-document-editor-dependency-audit.md#6-pending-coordinated-changes).
